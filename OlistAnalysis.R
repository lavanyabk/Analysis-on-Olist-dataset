...
setwd("D:/Fall-2018/BAR-Sourav/Project-Customer Churn/")
...
##PLotting lift ####
valid_1.df$review_score <- as.numeric(valid_1.df$review_score)
...
plot(c(0,gain$cume.pct.of.total*sum(valid_1.df$review_score))~c(0,gain$cume.obs), 
     xlab = "# cases", ylab = "classified", main = "Lift-chart", type = "l")
lines(c(0,sum(valid_1.df$review_score))~c(0, dim(valid_1.df)[1]), lty = 5,col="blue1")
